...
Generating web content from different visual content types and sizes has been a challenging aspect of working with RMarkdown and document generation. I found myself saying too many times recently that I hate working with images in websites before I could check myself. This seems to make it obvious to me that I need to get this "down-pac" as soon as possible. Here are my notes in another attempt to do so....
