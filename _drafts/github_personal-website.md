...
### <a id="user-content-fork-the-githubpersonal-website-repo"></a>[](#fork-the-githubpersonal-website-repo)Fork the `github/personal-website` repo
...
### <a id="user-content-install-in-your-local-development-environment"></a>[](#install-in-your-local-development-environment)Install in your local development environment
...
#### <a id="user-content-install-jekyll"></a>[](#install-jekyll)Install Jekyll
...
### <a id="user-content-publish"></a>[](#publish)Publish
...
## <a id="user-content-customization"></a>[](#customization)Customization
...
### <a id="user-content-quick-configuration-changes"></a>[](#quick-configuration-changes)Quick configuration changes
...
#### <a id="user-content-layout"></a>[](#layout)Layout
...
#### <a id="user-content-style"></a>[](#style)Style
...
#### <a id="user-content-projects"></a>[](#projects)Projects
...
#### <a id="user-content-topics"></a>[](#topics)Topics
...
#### <a id="user-content-social-media"></a>[](#social-media)Social media
...
## <a id="user-content-adding-pages"></a>[](#adding-pages)Adding pages
...
## <a id="user-content-adding-blog-posts"></a>[](#adding-blog-posts)Adding blog posts
...
## <a id="user-content-content-and-templates"></a>[](#content-and-templates)Content and templates
...
### <a id="user-content-layouts"></a>[](#layouts)Layouts
...
## <a id="user-content-styles"></a>[](#styles)Styles
