...
Below I have used code chunks to help collect the different variables in the Front Matter of my website based on the Jekyll template called `Beautiful`. And here is the same code with syntax highlighting.
