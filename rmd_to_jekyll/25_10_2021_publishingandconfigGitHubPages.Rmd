...
#knitr directions for jekyll blog
#coming...
```
...
3.  Under your repository name, click **Settings**.
    ...
    <img width="521" height="57" src="assets/img/43eb79b43f96494ea83f5033d25a2861.png"/>
    
4.  Use the Select source drop-down menu to select **master branch /docs folder** as your GitHub Pages publishing source.
    
    ![select-master-branch-docs-folder-as-source](assets/img/4bc3de1b33904ee787083374365a4d5f.png)
...
5.  Click **Save**.
    ...
    <img width="521" height="164" src="assets/img/99d712290b714de4bae771a8da939118.png"/>
